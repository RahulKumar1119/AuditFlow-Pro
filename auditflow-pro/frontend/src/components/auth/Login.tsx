            ...
            <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
              ...
              <div className="w-full max-w-md mx-auto lg:mx-0">
                <div className="bg-white/90 backdrop-blur-xl rounded-2xl lg:rounded-3xl shadow-2xl border border-white/50 p-6 sm:p-8 lg:p-10">
                  ...
                  {/* Login Form or New Password Form */}
                  {!showNewPasswordForm ? (
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <input
                            ...
                            required
                            className="block w-full pl-12 pr-12 py-4 rounded-2xl border-2 border-slate-200 bg-white text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:outline-none focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 hover:border-slate-300 hover:shadow-sm"
                            placeholder="••••••••"
                            value={password}
                    ...
                    <form className="space-y-6" onSubmit={handleNewPasswordSubmit}>
                      ...
                      <button
                        type="submit"
                        disabled={isLoading}
                        className="group relative w-full flex justify-center items-center space-x-2 rounded-2xl bg-gradient-to-r from-green-600 via-emerald-600 to-green-700 px-6 py-4 text-base font-semibold text-white shadow-xl shadow-green-500/30 hover:shadow-2xl hover:shadow-green-600/40 hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-green-500/50 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 transition-all duration-300 overflow-hidden"
                      >
                        <div className="absolute inset-0 bg-gradient-to-r from-green-700 via-emerald-700 to-green-800 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                        {isLoading ? (
                          <>
                            <svg className="animate-spin h-5 w-5 text-white relative z-10" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                              <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
