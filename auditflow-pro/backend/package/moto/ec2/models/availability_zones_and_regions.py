...
class RegionsAndZonesBackend:
    ...
    zones = {
        ...
        "ap-south-1": [
            Zone(region_name="ap-south-1", name="ap-south-1a", zone_id="use1-az6"),
            Zone(region_name="ap-south-1", name="ap-south-1b", zone_id="use1-az1"),
            Zone(region_name="ap-south-1", name="ap-south-1c", zone_id="use1-az2"),
            Zone(region_name="ap-south-1", name="ap-south-1d", zone_id="use1-az4"),
            Zone(region_name="ap-south-1", name="ap-south-1e", zone_id="use1-az3"),
            Zone(region_name="ap-south-1", name="ap-south-1f", zone_id="use1-az5"),
        ],
        "us-west-1": [
